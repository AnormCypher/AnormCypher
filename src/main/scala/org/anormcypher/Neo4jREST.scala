...
object Neo4jREST {
  ...
  def setServer(host:String="localhost", port:Int=7474, path:String="/db/data/"):Unit = {
    setServer(host, port, path, "", "")
  }

  def setServer(host:String, port:Int, path:String, username:String, password:String):Unit = {
